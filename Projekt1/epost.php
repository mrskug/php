...
<div id="innehall">
<article>
<h3>E-post och lösenord i php</h3>
<section>
Registrera dig på vår webbplats.
<form name="reg" method="post" action="epost.php">
Ge användarnamn: <input name="anvnamn" type="text" size="20" /><br/>
Ge e-postadress: <input name="epost" type="text" size="40" /><br/>
<input name="registrera" type="submit" value="Registrera mig" />
</form>
</section>
<section>
</section>
