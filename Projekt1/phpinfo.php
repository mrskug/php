...
<div class="center">
        ...
        <tr class="h">
            <td>
                <a href="http://www.php.net/"><img border="0"
                                                   src="/~johnny/php2014/Projekt 1/phpinfo.php?=PHPE9568F34-D428-11d2-A769-00AA001ACF42"
                                                   alt="PHP Logo"/></a>

                <h1 class="p">PHP Version 5.4.36-0+deb7u3</h1>
            </td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
        <tr>
            ...
            <td class="v">Linux cgi 3.2.0-4-amd64 #1 SMP Debian 3.2.65-1+deb7u1 x86_64</td>
        </tr>
        <tr>
            <td class="e">Build Date</td>
            <td class="v">Jan 9 2015 08:06:28</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">/etc/php5/apache2</td>
        </tr>
        <tr>
            <td class="e">Loaded Configuration File</td>
            <td class="v">/etc/php5/apache2/php.ini</td>
        </tr>
        <tr>
            <td class="e">Scan this dir for additional .ini files</td>
            <td class="v">/etc/php5/apache2/conf.d</td>
        </tr>
        <tr>
            <td class="e">Additional .ini files parsed</td>
            <td class="v">/etc/php5/apache2/conf.d/10-pdo.ini,
        ...
        <tr class="v">
            <td>
                <a href="http://www.zend.com/"><img border="0"
                                                    src="/~johnny/php2014/Projekt 1/phpinfo.php?=PHPE9568F35-D428-11d2-A769-00AA001ACF42"
                                                    alt="Zend logo"/></a>
                This program makes use of the Zend Scripting Language Engine:<br/>Zend&nbsp;Engine&nbsp;v2.4.0,&nbsp;Copyright&nbsp;(c)&nbsp;1998-2014&nbsp;Zend&nbsp;Technologies<br/>
            </td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr>
            ...
            <td class="v">Apache/2.2.22 (Debian)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">root@arcada.fi</td>
        </tr>
        <tr>
            <td class="e">Hostname:Port</td>
            <td class="v">cgi.arcada.fi:0</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">core mod_log_config mod_logio mod_version prefork http_core mod_so mod_alias mod_auth_basic
                mod_authn_file mod_authz_default mod_authz_groupfile mod_authz_host mod_authz_user mod_autoindex mod_cgi
                mod_deflate mod_dir mod_env mod_mime mod_negotiation mod_php5 mod_pubcookie mod_reqtimeout mod_setenvif
                mod_ssl mod_status mod_userdir
            </td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">cgi.arcada.fi</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_C</td>
            <td class="v">FI</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_ST</td>
            <td class="v">Nyland</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_L</td>
            <td class="v">Helsingfors</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_O</td>
            <td class="v">Stiftelsen Arcada</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_OU</td>
            <td class="v">IT-centralen</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN_CN</td>
            <td class="v">cgi.arcada.fi</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_I_DN_C</td>
            <td class="v">NL</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_I_DN_O</td>
            <td class="v">TERENA</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_I_DN_CN</td>
            <td class="v">TERENA SSL CA</td>
        </tr>
        <tr>
            <td class="e">SSL_VERSION_INTERFACE</td>
            <td class="v">mod_ssl/2.2.22</td>
        </tr>
        <tr>
            <td class="e">SSL_VERSION_LIBRARY</td>
            <td class="v">OpenSSL/1.0.1e</td>
        </tr>
        <tr>
            <td class="e">SSL_PROTOCOL</td>
            <td class="v">TLSv1.2</td>
        </tr>
        <tr>
            <td class="e">SSL_SECURE_RENEG</td>
            <td class="v">true</td>
        </tr>
        <tr>
            <td class="e">SSL_COMPRESS_METHOD</td>
            <td class="v">NULL</td>
        </tr>
        <tr>
            <td class="e">SSL_CIPHER</td>
            <td class="v">ECDHE-RSA-AES256-GCM-SHA384</td>
        </tr>
        <tr>
            <td class="e">SSL_CIPHER_EXPORT</td>
            <td class="v">false</td>
        </tr>
        <tr>
            <td class="e">SSL_CIPHER_USEKEYSIZE</td>
            <td class="v">256</td>
        </tr>
        <tr>
            <td class="e">SSL_CIPHER_ALGKEYSIZE</td>
            <td class="v">256</td>
        </tr>
        <tr>
            <td class="e">SSL_CLIENT_VERIFY</td>
            <td class="v">NONE</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_M_VERSION</td>
            <td class="v">3</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_M_SERIAL</td>
            <td class="v">8D78B86866439B0AA76F231EE1EA1A6B</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_V_START</td>
            <td class="v">Apr 4 00:00:00 2012 GMT</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_V_END</td>
            <td class="v">Apr 4 23:59:59 2015 GMT</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_S_DN</td>
            <td class="v">/C=FI/postalCode=00550/ST=Nyland/L=Helsingfors/street=Jan-Magnus Janssons Plats 1/O=Stiftelsen
                Arcada/OU=IT-centralen/CN=cgi.arcada.fi
            </td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_I_DN</td>
            <td class="v">/C=NL/O=TERENA/CN=TERENA SSL CA</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_A_KEY</td>
            <td class="v">rsaEncryption</td>
        </tr>
        <tr>
            <td class="e">SSL_SERVER_A_SIG</td>
            <td class="v">sha1WithRSAEncryption</td>
        </tr>
        <tr>
            <td class="e">HTTP_REFERER</td>
            <td class="v">https://cgi.arcada.fi/~johnny/php2014/Projekt%201/</td>
        </tr>
        <tr>
            <td class="e">HTTP_USER_AGENT</td>
            <td class="v">Wget/1.16.1 (linux-gnu)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">besok=2;
                pubcookie_s_cgiserver=;
                SESS42e3dbcf912027c7741b2069446f413b=frjcn13s9j0cdd95oemop3teb6;
                __utma=208200130.695605109.1412759689.1418043517.1422849383.5;
                __utmv=208200130.|1=User%20roles=anonymous%20user=1;
                __utmz=208200130.1415109562.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none);
                _ga=GA1.2.695605109.1412759689
            </td>
        </tr>
        <tr>
            <td class="e">PATH</td>
            <td class="v">
                /usr/local/bin:/usr/local/sbin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/sbin:/usr/sbin:/root/scripts
            </td>
        </tr>
        <tr>
            <td class="e">SERVER_SIGNATURE</td>
            <td class="v">&lt;address&gt;Apache/2.2.22 (Debian) Server at cgi.arcada.fi Port 443&lt;/address&gt;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">2001:708:170:33::14</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">2001:14b8:100:8380:221:5cff:fe62:fc35</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">/home/j/johnny/html/php2014/Projekt 1/phpinfo.php</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">REMOTE_USER</td>
            <td class="v">holmberc</td>
        </tr>
        <tr>
            <td class="e">AUTH_TYPE</td>
            <td class="v">EGNetID</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">/~johnny/php2014/Projekt%201/phpinfo.php</td>
        </tr>
        <tr>
            <td class="e">SCRIPT_NAME</td>
            <td class="v">/~johnny/php2014/Projekt 1/phpinfo.php</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">GET /~johnny/php2014/Projekt%201/phpinfo.php HTTP/1.1</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">PHP/5.4.36-0+deb7u3</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">/usr/lib/php5/20100525</td>
            <td class="v">/usr/lib/php5/20100525</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="v">.:/usr/share/php:/usr/share/pear</td>
            <td class="v">.:/usr/share/php:/usr/share/pear</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">dict, file, ftp, ftps, gopher, http, https, imap, imaps, ldap, pop3, pop3s, rtmp, rtsp, scp,
    ...
    <table border="0" cellpadding="3" width="600">
        <tr>
            <td class="e">DBA support</td>
            <td class="v">enabled</td>
        </tr>
        <tr>
            <td class="e">Supported handlers</td>
            <td class="v">cdb cdb_make db4 inifile flatfile qdbm</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">dba.default_handler</td>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">1.4 $Id: 637ebf9289b40d157fdf8edcdddeb3d907b28d9b $</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">$Id: ad78b4a085153b8c7f4d6db5dc69df40e969c343 $</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">md2 md4 md5 sha1 sha224 sha256 sha384 sha512 ripemd128 ripemd160 ripemd256 ripemd320 whirlpool
                tiger128,3 tiger160,3 tiger192,3 tiger128,4 tiger160,4 tiger192,4 snefru snefru256 gost adler32 crc32
                crc32b fnv132 fnv164 joaat haval128,3 haval160,3 haval192,3 haval224,3 haval256,3 haval128,4 haval160,4
                haval192,4 haval224,4 haval256,4 haval128,5 haval160,5 haval192,5 haval224,5 haval256,5
            </td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr>
            <td class="e">LDAP Support</td>
            <td class="v">enabled</td>
        </tr>
        <tr>
            <td class="e">RCS Version</td>
            <td class="v">$Id: 2dabc34c4033eedc9d7fa05f16544cdb14121c4e $</td>
        </tr>
        <tr>
            <td class="e">Total Links</td>
            <td class="v">0/unlimited</td>
        </tr>
        <tr>
            <td class="e">API Version</td>
            <td class="v">3001</td>
        </tr>
        <tr>
            <td class="e">Vendor Name</td>
            <td class="v">OpenLDAP</td>
        </tr>
        <tr>
            <td class="e">Vendor Version</td>
            <td class="v">20431</td>
        </tr>
        <tr>
            <td class="e">SASL Support</td>
            <td class="v">Enabled</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr class="h">
            <th>mbstring extension makes use of "streamable kanji code filter and converter", which is distributed under
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">Api No</td>
            <td class="v">20021217</td>
        </tr>
        <tr>
            <td class="e">Supported ciphers</td>
            <td class="v">cast-128 gost rijndael-128 twofish arcfour cast-256 loki97 rijndael-192 saferplus wake
                blowfish-compat des rijndael-256 serpent xtea blowfish enigma rc2 tripledes
            </td>
        </tr>
        <tr>
            <td class="e">Supported modes</td>
            <td class="v">cbc cfb ctr ecb ncfb nofb ofb stream</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">mcrypt.algorithms_dir</td>
            <td class="v"><i>no value</i></td>
            <td class="v"><i>no value</i></td>
        </tr>
        <tr>
            <td class="e">mcrypt.modes_dir</td>
            <td class="v"><i>no value</i></td>
            <td class="v"><i>no value</i></td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">5.5.41</td>
        </tr>
        <tr>
            <td class="e">MYSQL_MODULE_TYPE</td>
            <td class="v">external</td>
        </tr>
        <tr>
            <td class="e">MYSQL_SOCKET</td>
            <td class="v">/var/run/mysqld/mysqld.sock</td>
        </tr>
        <tr>
            <td class="e">MYSQL_INCLUDE</td>
            <td class="v">-I/usr/include/mysql</td>
        </tr>
        <tr>
            <td class="e">MYSQL_LIBS</td>
            <td class="v">-L/usr/lib/x86_64-linux-gnu -lmysqlclient_r</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">Client API header version</td>
            <td class="v">5.5.38</td>
        </tr>
        <tr>
            <td class="e">MYSQLI_SOCKET</td>
            <td class="v">/var/run/mysqld/mysqld.sock</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">OpenSSL 1.0.1e 11 Feb 2013</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">$Id: ec823514107160b7e6fabc519594012657a2db91 $</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr class="v">
            <td>
                ...
                Beaver and Marcus Boerger.<br/>Portions of tar implementation Copyright (c) 2003-2009 Tim Kientzle.
            </td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr>
            <td class="e">Revision</td>
            <td class="v">$Id: 1dfa9997ed76804e53c91e0ce862f3707617b6ed $</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">Version</td>
            <td class="v">$Id: f6367cdb4e3f392af4a6d441a6641de87c2e50c4 $</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">php php_binary wddx</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">Revision</td>
            <td class="v">$Id: 16070fc92ad6f69cebb2d52ad3f02794f833ce39 $</td>
        </tr>
        <tr>
            <td class="e">Schema support</td>
            <td class="v">enabled</td>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr>
            <td class="e">Soap Client</td>
            <td class="v">enabled</td>
        </tr>
        <tr>
            <td class="e">Soap Server</td>
            <td class="v">enabled</td>
        </tr>
    </table>
    <br/>
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">soap.wsdl_cache</td>
            <td class="v">1</td>
            <td class="v">1</td>
        </tr>
        <tr>
            <td class="e">soap.wsdl_cache_dir</td>
            <td class="v">/tmp</td>
            <td class="v">/tmp</td>
        </tr>
        <tr>
            <td class="e">soap.wsdl_cache_enabled</td>
            <td class="v">1</td>
            <td class="v">1</td>
        </tr>
        <tr>
            <td class="e">soap.wsdl_cache_limit</td>
            <td class="v">5</td>
            <td class="v">5</td>
        </tr>
        <tr>
            <td class="e">soap.wsdl_cache_ttl</td>
            <td class="v">86400</td>
            <td class="v">86400</td>
        </tr>
    </table>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">AppendIterator, ArrayIterator, ArrayObject, BadFunctionCallException, BadMethodCallException,
                CachingIterator, CallbackFilterIterator, DirectoryIterator, DomainException, EmptyIterator,
                FilesystemIterator, FilterIterator, GlobIterator, InfiniteIterator, InvalidArgumentException,
                IteratorIterator, LengthException, LimitIterator, LogicException, MultipleIterator, NoRewindIterator,
                OutOfBoundsException, OutOfRangeException, OverflowException, ParentIterator, RangeException,
                ...
                RecursiveTreeIterator, RegexIterator, RuntimeException, SplDoublyLinkedList, SplFileInfo, SplFileObject,
                SplFixedArray, SplHeap, SplMinHeap, SplMaxHeap, SplObjectStorage, SplPriorityQueue, SplQueue, SplStack,
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">Revision</td>
            <td class="v">$Id: adf1d2d6be849c46eed3c3ee6f1cbebd1448d6e5 $</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            ...
            <td class="v">$Id: abc21c7f1559e732dba6db94c69ecf638ae5fa3f $</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">LESSOPEN</td>
            <td class="v">| /usr/bin/lesspipe %s</td>
        </tr>
        <tr>
            <td class="e">MAIL</td>
            <td class="v">/var/mail/root</td>
        </tr>
        <tr>
            <td class="e">SSH_CLIENT</td>
            <td class="v">2001:708:170:33::32 34171 22</td>
        </tr>
        <tr>
            <td class="e">USER</td>
            <td class="v">root</td>
        ...
        <tr>
            <td class="e">LANGUAGE</td>
            <td class="v">en_US:en</td>
        </tr>
        <tr>
            <td class="e">LC_TIME</td>
            <td class="v">C</td>
        </tr>
        <tr>
            <td class="e">SHLVL</td>
        ...
        <tr>
            <td class="e">OLDPWD</td>
            <td class="v">/root</td>
        </tr>
        <tr>
            <td class="e">SSH_TTY</td>
            <td class="v">/dev/pts/1</td>
        </tr>
        <tr>
            <td class="e">PAGER</td>
            <td class="v">less</td>
        ...
        <tr>
            <td class="e">PS1</td>
            <td class="v">
                \[\033[33;40;1m\]root\[\033[;0m\[\033[37;40;1m\]@\[\033[31;40;1m\]\h\[\033[37;40;1m\][\[\033[33;40;1m\]\w\[\033[37;40;1m\]]\[\033[;0m\]
                #
            </td>
        </tr>
        <tr>
            <td class="e">LC_MONETARY</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">LC_CTYPE</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">PS2</td>
            <td class="v">2\033[32;40;1m&gt;\033[0m</td>
        </tr>
        <tr>
            <td class="e">VISUAL</td>
            <td class="v">pico</td>
        </tr>
        <tr>
            <td class="e">APACHE_PID_FILE</td>
            <td class="v">/var/run/apache2.pid</td>
        </tr>
        <tr>
            <td class="e">LOGNAME</td>
            <td class="v">root</td>
        </tr>
        <tr>
            <td class="e">_</td>
            <td class="v">/usr/sbin/apachectl</td>
        </tr>
        <tr>
            <td class="e">TERM</td>
            <td class="v">xterm</td>
        ...
        <tr>
            <td class="e">LESSCHARSET</td>
            <td class="v">utf-8</td>
        </tr>
        <tr>
            <td class="e">LC_ADDRESS</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">DISPLAY</td>
            <td class="v">localhost:10.0</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">LS_COLORS</td>
            <td class="v">
                no=00:fi=00:di=01;37:ln=01;36:pi=40;33:so=01;35:bd=40;33;01:cd=40;33;01:ex=01;32:*.cmd=01;32:*.exe=01;32:*.com=01;32:*.btm=01;32:*.bat=01;32:*.tar=01;31:*.tgz=01;31:*.bz2=01;31:*.arj=01;31:*.taz=01;31:*.lzh=01;31:*.zip=01;31:*.z=01;31:*.Z=01;31:*.gz=01;31:*.jpg=01;35:*.gif=01;35:*.bmp=01;35:*.xbm=01;35:*.xpm=01;35:*.tif=01;35:
            </td>
        </tr>
        <tr>
            <td class="e">LC_MESSAGES</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">SHELL</td>
            <td class="v">/bin/bash</td>
        </tr>
        <tr>
            <td class="e">LC_NAME</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">PROMPT_COMMAND</td>
            <td class="v">echo -en &#039;\033&#039;]2\;$USER@cgi:$PWD&#039;\007&#039; </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">LESSCLOSE</td>
            <td class="v">/usr/bin/lesspipe %s %s</td>
        </tr>
        <tr>
            <td class="e">LC_MEASUREMENT</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">LC_IDENTIFICATION</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">PWD</td>
        ...
        <tr>
            <td class="e">SSH_CONNECTION</td>
            <td class="v">2001:708:170:33::32 34171 2001:708:170:33::14 22</td>
        </tr>
        <tr>
            <td class="e">LC_NUMERIC</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">LC_PAPER</td>
            <td class="v">en_US.utf8</td>
        </tr>
        <tr>
            <td class="e">HISTFILE</td>
            <td class="v">/root/.bash_history.root.30.01.15</td>
        </tr>
        <tr>
            <td class="e">LS_OPTIONS</td>
            <td class="v"> --time-style locale --color=auto</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="3" width="600">
        ...
        <tr>
            <td class="e">_COOKIE["besok"]</td>
            <td class="v">2</td>
        </tr>
        <tr>
            <td class="e">_COOKIE["pubcookie_s_cgiserver"]</td>
            <td class="v">
        ...
        <tr>
            <td class="e">_COOKIE["SESS42e3dbcf912027c7741b2069446f413b"]</td>
            <td class="v">frjcn13s9j0cdd95oemop3teb6</td>
        </tr>
        <tr>
            <td class="e">_COOKIE["__utma"]</td>
            <td class="v">208200130.695605109.1412759689.1418043517.1422849383.5</td>
        </tr>
        <tr>
            <td class="e">_COOKIE["__utmv"]</td>
            <td class="v">208200130.|1=User roles=anonymous user=1</td>
        </tr>
        <tr>
            <td class="e">_COOKIE["__utmz"]</td>
            <td class="v">208200130.1415109562.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)</td>
        </tr>
        <tr>
            <td class="e">_COOKIE["_ga"]</td>
            <td class="v">GA1.2.695605109.1412759689</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_C"]</td>
            <td class="v">FI</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_ST"]</td>
            <td class="v">Nyland</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_L"]</td>
            <td class="v">Helsingfors</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_O"]</td>
            <td class="v">Stiftelsen Arcada</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_OU"]</td>
            <td class="v">IT-centralen</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN_CN"]</td>
            <td class="v">cgi.arcada.fi</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_I_DN_C"]</td>
            <td class="v">NL</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_I_DN_O"]</td>
            <td class="v">TERENA</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_I_DN_CN"]</td>
            <td class="v">TERENA SSL CA</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_VERSION_INTERFACE"]</td>
            <td class="v">mod_ssl/2.2.22</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_VERSION_LIBRARY"]</td>
            <td class="v">OpenSSL/1.0.1e</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_PROTOCOL"]</td>
            <td class="v">TLSv1.2</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SECURE_RENEG"]</td>
            <td class="v">true</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_COMPRESS_METHOD"]</td>
            <td class="v">NULL</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_CIPHER"]</td>
            <td class="v">ECDHE-RSA-AES256-GCM-SHA384</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_CIPHER_EXPORT"]</td>
            <td class="v">false</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_CIPHER_USEKEYSIZE"]</td>
            <td class="v">256</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_CIPHER_ALGKEYSIZE"]</td>
            <td class="v">256</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_CLIENT_VERIFY"]</td>
            <td class="v">NONE</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_M_VERSION"]</td>
            <td class="v">3</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_M_SERIAL"]</td>
            <td class="v">8D78B86866439B0AA76F231EE1EA1A6B</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_V_START"]</td>
            <td class="v">Apr 4 00:00:00 2012 GMT</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_V_END"]</td>
            <td class="v">Apr 4 23:59:59 2015 GMT</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_S_DN"]</td>
            <td class="v">/C=FI/postalCode=00550/ST=Nyland/L=Helsingfors/street=Jan-Magnus Janssons Plats 1/O=Stiftelsen
                Arcada/OU=IT-centralen/CN=cgi.arcada.fi
            </td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_I_DN"]</td>
            <td class="v">/C=NL/O=TERENA/CN=TERENA SSL CA</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_A_KEY"]</td>
            <td class="v">rsaEncryption</td>
        </tr>
        <tr>
            <td class="e">_SERVER["SSL_SERVER_A_SIG"]</td>
            <td class="v">sha1WithRSAEncryption</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">_SERVER["REMOTE_USER"]</td>
            <td class="v">holmberc</td>
        </tr>
        <tr>
            <td class="e">_SERVER["AUTH_TYPE"]</td>
            <td class="v">EGNetID</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="e">_SERVER["PHP_AUTH_USER"]</td>
            <td class="v">holmberc</td>
        </tr>
        <tr>
            <td class="e">_SERVER["REQUEST_TIME_FLOAT"]</td>
            <td class="v">1423141827.735</td>
        </tr>
        <tr>
            <td class="e">_SERVER["REQUEST_TIME"]</td>
            <td class="v">1423141827</td>
        </tr>
    </table>
    <br/>
    ...
    <table border="0" cellpadding="3" width="600">
        <tr class="v">
            <td>
                <p>
                    This program is free software; you can redistribute it and/or modify it under the terms of the PHP
                    License as published by the PHP Group and included in the distribution in the file: LICENSE
                </p>
                ...
                <p>If you did not receive a copy of the PHP license, or have any questions about PHP licensing, please
