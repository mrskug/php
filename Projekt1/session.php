...
Logga in på vår webbplats.<br/><form name="reg" method="post" action="session.php">Ge användarnamn: <input name="anvnamn" type="text" size="20" /><br/>Ge lösenord: <input name="losen" type="password" size="20" /><br/><input name="registrera" type="submit" value="Logga in" /></form>Sessionsarean innehåller<br/>Array
(
    [sessionstest] => 1
)
</section>
